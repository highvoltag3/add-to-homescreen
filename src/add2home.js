/*!
 * We've modified this script but it is based on:
...
var addToHome = (function (w) {
    var nav = w.navigator,
        ...
        intl = {
            en_us: 'Install Mobile Zap on your %device: tap %icon and then <strong>Add to Home Screen</strong>.'
        };
    ...
    function loaded () {
        ...
        // Localize message
        // Dario's note for our use we only need English so the logic for the internationalization was removed and defaulted to en_us
        ...
        balloon.innerHTML = touchIcon +
            ...
            (options.closeButton ? '<span class="addToHomeClose">X</span>' : '');
